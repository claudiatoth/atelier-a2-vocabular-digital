// PDF BUILDER — Atelier A2: Vocabular digital (de bază)
(function () {
    ...
    function buildCast() {
        return `<div class="cast-banner">
            ...
            <div class="cast-grid">
                <div class="cast-card"><img src="images/acar.png" alt="Acar"><div class="name">Acar</div><div class="detail">Învață cuvintele</div></div>
                <div class="cast-card"><img src="images/andreea.png" alt="Andreea"><div class="name">Andreea 🇷🇴</div><div class="detail">Îl ajută</div></div>
    ...
    function buildTheory() {
        ...
        return `<h1 class="chapter">📘 1. Teorie — Vocabular digital (de bază)</h1>` + t;
    }
    ...
    function buildExercises() {
        ...
        if (typeof ex1Data !== 'undefined') {
            html += fillPromptBlock('Übung 1 — Articolul corect (der/die/das)', 'Învață mereu substantivul cu articolul lui. Indiciul îți spune genul.', ex1Data);
        }
        if (typeof ex2Data !== 'undefined') {
            html += choiceBlock('Übung 2 — Ce cuvânt? (descriere)', 'Alege cuvântul care se potrivește descrierii.', ex2Data);
        }
        if (typeof ex3Data !== 'undefined') {
            html += fillPromptBlock('Übung 3 — Cuvântul digital în propoziție', 'Completează substantivul digital potrivit.', ex3Data);
        }
        if (typeof ex4Data !== 'undefined') {
            html += fillPromptBlock('Übung 4 — Verbul digital potrivit', 'Verbe simple la forma „ich": klicke, öffne, speichere, suche, schreibe, drucke, lösche.', ex4Data);
        }
        if (typeof ex5Data !== 'undefined') {
            html += translateBlock('Übung 5 — Traducere RO → DE', 'Nu uita articolul (der/die/das) la substantive.', ex5Data);
        }
        return html;
    }
    ...
    function buildVerbs() {
        let html = `<h1 class="chapter new-section">🔁 4. Verbele digitale — Präsens · Präteritum · Perfekt</h1>
            <div class="andreea-note">
                <div class="andreea-note-content">
                    <div class="speaker">📌 Andreea îți spune:</div>
                    <div>Cu klicken, öffnen, speichern, suchen, schreiben, drucken descrii aproape orice la computer. 5 sunt regulate; schreiben e tare: schrieb → geschrieben.</div>
                </div>
            </div>`;
